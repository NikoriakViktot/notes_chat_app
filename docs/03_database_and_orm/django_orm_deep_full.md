> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/DJANGO_ORM_DEEP.md`.
...
> 🔬 **Інтерактивна лабораторія:** [`docs/reference/legacy_source/orm_laboratory_reference.md`](../reference/legacy_source/orm_laboratory_reference.md)
>
...
python manage.py sqlmigrate notes_app 0002

# Відкотити до певної міграції (НЕБЕЗПЕЧНО — втрата даних!)
python manage.py migrate notes_app 0001
```
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notes_app', '0002_extended_models'),
    ]
