> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/AUTH_BASICS.md`.
...
> **Проєкт:** `crispy_notes_chat_app` (lesson_Django_authentication_and_security)
...
| `notes_app/views.py` | `@login_required` на кожному захищеному view |
