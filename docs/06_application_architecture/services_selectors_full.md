> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/DJANGO_SERVICES_SELECTORS.md`.
...
| Тема | Файл |
|------|------|
| Загальна архітектура Django | [django_architecture.md](../02_django_core/django_architecture_full.md) |
| ORM, QuerySet, N+1, транзакції | [Django_ORM.md](../03_database_and_orm/django_orm_full.md) |
| Views: FBV, CBV, Generic | [Django_Views.md](../02_django_core/views_full.md) |
| Архітектурні схеми (Mermaid) | [django_mermaid.md](../02_django_core/django_mermaid_full.md) |
| Структура проєкту | [DJANGO_PROJECT_STRUCTURE.md](../02_django_core/project_structure_full.md) |
