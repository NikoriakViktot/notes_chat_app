> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/DJANGO_SERVICES.md`.
...
| Тема | Файл |
|------|------|
| Selectors (читання даних) | [DJANGO_SELECTORS.md](django_selectors_full.md) |
| Services + Selectors + Serializers (повна картина) | [DJANGO_SERVICES_SELECTORS.md](services_selectors_full.md) |
| ORM: `full_clean`, `save`, транзакції | [DJANGO_ORM_DEEP.md](../03_database_and_orm/django_orm_deep_full.md) |
| Views: як передати дані у Service | [notes_chat_app/README.md](../../README.md) — Крок 8 |
