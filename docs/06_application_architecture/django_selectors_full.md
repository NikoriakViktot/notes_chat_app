...
| Тема | Файл |
|------|------|
| Services (бізнес-логіка, мутації, транзакції) | [DJANGO_SERVICES.md](django_services_full.md) |
| Services + Selectors + Serializers (повна картина) | [DJANGO_SERVICES_SELECTORS.md](services_selectors_full.md) |
| ORM: QuerySet API, N+1, `select_related` | [DJANGO_ORM_DEEP.md](../03_database_and_orm/django_orm_deep_full.md) |
| Views: як викликати Selector з View | [notes_chat_app/README.md](../../README.md) — Крок 8 |
