...
| Тема | Файл |
|------|------|
| Services (що робити з `validated_data`) | [DJANGO_SERVICES.md](django_services_full.md) |
| Selectors (як підготувати дані для OutputSerializer) | [DJANGO_SELECTORS.md](django_selectors_full.md) |
| Services + Selectors + Serializers (повна картина) | [DJANGO_SERVICES_SELECTORS.md](services_selectors_full.md) |
| Views: як поєднати все разом | [Django_Views.md](../02_django_core/views_full.md) |
