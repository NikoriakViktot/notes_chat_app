> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/DJANGO_PROJECT_STRUCTURE.md`.
...
|------|------|-----------------------|
| `services.py` | Бізнес-логіка: мутації, транзакції, side effects | [DJANGO_SERVICES.md](../06_application_architecture/django_services_full.md) |
| `selectors.py` | Читання даних: named queries, ORM-оптимізації | [DJANGO_SELECTORS.md](../06_application_architecture/django_selectors_full.md) |
...
Детальніше: [DJANGO_SERVICES.md](../06_application_architecture/django_services_full.md)
...
Детальніше: [DJANGO_SELECTORS.md](../06_application_architecture/django_selectors_full.md)
