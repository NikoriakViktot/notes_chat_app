> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/django_architecture.md`.
...
|------|------|--------------|
| Мережевий фундамент | [network_foundation.md](../01_web_foundations/network_foundation_full.md) | IP, DNS, TCP, HTTP, HTTPS, sockets, REST |
| Мережеві схеми | [network_mermaid.md](../01_web_foundations/network_mermaid_full.md) | 11 Mermaid-діаграм мережевого стеку |
| Структура проєкту | [DJANGO_PROJECT_STRUCTURE.md](project_structure_full.md) | Кожен файл Django з роллю та помилками |
| Команди Django | [DJANGO_COMMAND_SYSTEM.md](management_commands_full.md) | Таблиця всіх команд + lifecycle |
| Міграції | [DJANGO_MIGRATIONS.md](../03_database_and_orm/django_migrations_full.md) | makemigrations, migrate, граф залежностей |
| ORM та БД | [Django_ORM.md](../03_database_and_orm/django_orm_full.md) | QuerySet API, N+1, транзакції, MVCC |
| URL Routing | [Django_URL_Routing.md](url_routing_full.md) | path(), include(), GET/POST, Forms |
| Views | [Django_Views.md](views_full.md) | FBV, CBV, Generic Views, lifecycle |
| Templates | [Django_Templates.md](../05_frontend_and_templates/django_templates_full.md) | DTL, context, security, inheritance |
| Django схеми | [django_mermaid.md](django_mermaid_full.md) | 15 Mermaid-діаграм архітектури Django |
| **Services** | [DJANGO_SERVICES.md](../06_application_architecture/django_services_full.md) | Бізнес-логіка: stateless функції, транзакції, on_commit |
| **Selectors** | [DJANGO_SELECTORS.md](../06_application_architecture/django_selectors_full.md) | Читання даних: named queries, N+1, CQRS-light |
| **Serializers** | [DJANGO_SERIALIZERS.md](../06_application_architecture/django_serializers_full.md) | Transport layer: InputSerializer, OutputSerializer |
| **Tasks** | [DJANGO_TASKS.md](../06_application_architecture/django_tasks_full.md) | Celery: broker, retry, on_commit, ідемпотентність |
| Повна картина | [DJANGO_SERVICES_SELECTORS.md](../06_application_architecture/services_selectors_full.md) | Services + Selectors + Serializers разом |
