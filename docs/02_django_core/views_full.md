> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/Django_Views.md`.
...
flowchart TD
    ...
    C -->|"path('notes/', include(...))"| D[notes_app URLs]
...
class NoteCreateView(LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('notes_app:note_list') # ← після успіху
...
| Services (бізнес-логіка, atomic, on_commit) | [DJANGO_SERVICES.md](../06_application_architecture/django_services_full.md) |
| Selectors (читання даних, N+1) | [DJANGO_SELECTORS.md](../06_application_architecture/django_selectors_full.md) |
| ORM: QuerySet, select_related, prefetch_related | [DJANGO_ORM_DEEP.md](../03_database_and_orm/django_orm_deep_full.md) |
| Практичний проект (notes_chat_app) | [notes_chat_app/README.md](../../README.md) |
