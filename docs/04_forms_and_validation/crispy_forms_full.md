...
| Файл | Що показує |
|------|-----------|
| [DESIGN_FOUNDATIONS.md §14](../05_frontend_and_templates/design_foundations_full.md#14-детальна-архітектура-crispy-forms) | Архітектура, конвеєри, before/after порівняння |
| [crispy_notes_app/forms.py](../../notes_app/forms.py) | **Реальний код** — NoteForm, NotebookForm, TagForm з FormHelper + Layout |
| [crispy_notes_chat_app/README.md](../../README.md) | Покроковий туторіал по crispy з 3-рівневим порівнянням |
