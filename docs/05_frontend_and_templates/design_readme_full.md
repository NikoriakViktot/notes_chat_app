> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/DESIGN_README.md`.
...
>
> Мова: **CrispyNotes** (`crispy_notes_chat_app`) — реальний проєкт курсу.
...
**Файл:** `crispy_notes_chat_app/templates/base.html`
...
<head>
  ...
  {% load static %}
  <link rel="stylesheet" href="{% static 'notes_app/css/app.css' %}">
...
└── notes_app/
    └── static/
        └── notes_app/               ← APP-LEVEL static (APP_DIRS=True)
            └── css/
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',   # ← папка crispy_notes_chat_app/static/
]
...
<!-- Підключення CSS -->
<link rel="stylesheet" href="{% static 'notes_app/css/app.css' %}">
<!--                                   ↑ шлях відносно notes_app/static/ -->

<!-- Підключення зображення -->
<img src="{% static 'notes_app/img/logo.png' %}" alt="Logo">
```
...
**Файл:** `notes_app/static/notes_app/css/app.css`
...
<a href="{% url 'notes_app:note_list' %}"
...
|------|--------|-------------|
| [`HTML_BASICS.md`](html_basics_full.md) | Початківець | HTML5 теги, семантика, структура документу |
| [`CSS_BASICS.md`](css_basics_full.md) | Початківець | Селектори, box model, flexbox, grid, media queries |
| [`BOOTSTRAP_5.md`](bootstrap_5_full.md) | Початківець+ | Grid, Flexbox utilities, компоненти, теми |
| [`DESIGN_FOUNDATIONS.md`](design_foundations_full.md) | Середній | UX/UI принципи, CRAP, типографіка, дизайн-системи |
| [`DJANGO_TEMPLATES_BOOTSTRAP.md`](django_templates_bootstrap_full.md) | Середній | Django шаблони + Bootstrap — інтеграція та паттерни |
| [`ADVANCED_TEMPLATES.md`](advanced_templates_full.md) | Середній+ | Context Processors, Dashboard Architecture, Crispy Forms |
| [`CRISPY_FORMS.md`](../04_forms_and_validation/crispy_forms_full.md) | Середній+ | FormHelper, Layout, Bootstrap 5 pack — повний довідник |
| [`DJANGO_NINJA_TEMPLATES.md`](../06_application_architecture/django_ninja_templates_full.md) | Просунутий | Django Ninja REST API + шаблони, HTMX |
| [`DJANGO_ADMIN_UNFOLD.md`](django_admin_unfold_full.md) | Просунутий | Кастомізація Django Admin через Unfold |
...
| Принципи UX, CRAP | [`DESIGN_FOUNDATIONS.md`](design_foundations_full.md) §1-2 |
| Bootstrap Grid детально | [`BOOTSTRAP_5.md`](bootstrap_5_full.md) |
| FormHelper + Layout | [`CRISPY_FORMS.md`](../04_forms_and_validation/crispy_forms_full.md) |
| Django template inheritance | [`ADVANCED_TEMPLATES.md`](advanced_templates_full.md) §2 |
| Context Processor | [`ADVANCED_TEMPLATES.md`](advanced_templates_full.md) §3 |
