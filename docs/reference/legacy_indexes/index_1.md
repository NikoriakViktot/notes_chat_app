> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/INDEX_1.md`.
...
| Файл | Що дає |
|------|--------|
| [network_foundation.md](../../01_web_foundations/network_foundation_full.md) | Системне розуміння Інтернету: IP, DNS, TCP, HTTP, HTTPS, REST API |
| [network_mermaid.md](../../01_web_foundations/network_mermaid_full.md) | Візуальні схеми: DNS resolving, TCP handshake, TLS, повний Browser→Server lifecycle |
...
| Файл | Що дає |
|------|--------|
| [django_architecture.md](../../02_django_core/django_architecture_full.md) | Загальний огляд Django як системи — MVT, middleware, ORM, WSGI/ASGI, production stack |
| [django_mermaid.md](../../02_django_core/django_mermaid_full.md) | 15 архітектурних схем: lifecycle, middleware chain, ORM, production deployment |
...
| Файл | Що дає |
|------|--------|
| [DJANGO_PROJECT_STRUCTURE.md](../../02_django_core/project_structure_full.md) | Кожен файл Django з точною роллю, помилками і ментальними моделями |
...
| Файл | Що дає |
|------|--------|
| [DJANGO_COMMAND_SYSTEM.md](../../02_django_core/management_commands_full.md) | Таблиця всіх команд + покроковий lifecycle від нуля до деплою |
| [DJANGO_MIGRATIONS.md](../../03_database_and_orm/django_migrations_full.md) | Механіка міграцій, граф залежностей, CI/CD |
...
| Файл | Що дає |
|------|--------|
| [Django_URL_Routing.md](../../02_django_core/url_routing_full.md) | URL Dispatcher, path converters, GET/POST params, Forms, ModelForms, CreateView |
...
| Файл | Що дає |
|------|--------|
| [Django_Views.md](../../02_django_core/views_full.md) | FBV vs CBV, Generic Views (ListView, DetailView, CreateView), lifecycle |
...
| Файл | Що дає |
|------|--------|
| [Django_Templates.md](../../05_frontend_and_templates/django_templates_full.md) | DTL синтаксис, context system, security (XSS), template inheritance |
...
| Файл | Що дає |
|------|--------|
| [Django_ORM.md](../../03_database_and_orm/django_orm_full.md) | QuerySet API, N+1 проблема, транзакції, MVCC, production пастки |
...
| Файл | Що дає |
|------|--------|
| [DJANGO_MIGRATIONS.md](../../03_database_and_orm/django_migrations_full.md) | Механіка міграцій, граф залежностей, типові проблеми |
...
| Файл | Що дає |
|------|--------|
| [DJANGO_SERVICES_SELECTORS.md](../../06_application_architecture/services_selectors_full.md) | Бізнес-шар: Services (мутації), Selectors (читання), Serializers як transport boundary |
| [DJANGO_SERVICES.md](../../06_application_architecture/django_services_full.md) | Тільки `services.py`: stateless функції, транзакції, `on_commit`, side effects, шаблони |
| [DJANGO_SELECTORS.md](../../06_application_architecture/django_selectors_full.md) | Тільки `selectors.py`: CQRS-light, named queries, N+1, ORM-оптимізації, шаблони |
| [DJANGO_SERIALIZERS.md](../../06_application_architecture/django_serializers_full.md) | Тільки `serializers.py`: Input/Output, `validate()`, поля, pure Python функція, помилки |
| [DJANGO_TASKS.md](../../06_application_architecture/django_tasks_full.md) | Тільки `tasks.py`: Celery, broker, retry, `on_commit`, ідемпотентність, шаблони |
...
| Питання | Де шукати |
|---------|-----------|
| Як налаштувати URL? | [Django_URL_Routing.md](../../02_django_core/url_routing_full.md) |
| Як написати View? | [Django_Views.md](../../02_django_core/views_full.md) |
| Як написати Template? | [Django_Templates.md](../../05_frontend_and_templates/django_templates_full.md) |
| Як написати Model? | [Django_ORM.md](../../03_database_and_orm/django_orm_full.md) |
| Що таке міграція? | [DJANGO_MIGRATIONS.md](../../03_database_and_orm/django_migrations_full.md) |
| Яка команда що робить? | [DJANGO_COMMAND_SYSTEM.md](../../02_django_core/management_commands_full.md) |
| Що таке кожен файл? | [DJANGO_PROJECT_STRUCTURE.md](../../02_django_core/project_structure_full.md) |
| Як працює DNS? | [network_foundation.md](../../01_web_foundations/network_foundation_full.md) |
| Що таке TCP? | [network_foundation.md](../../01_web_foundations/network_foundation_full.md) |
| Архітектурні схеми | [django_mermaid.md](../../02_django_core/django_mermaid_full.md) |
| Мережеві схеми | [network_mermaid.md](../../01_web_foundations/network_mermaid_full.md) |
| Де живе бізнес-логіка? | [DJANGO_SERVICES.md](../../06_application_architecture/django_services_full.md) |
| Що таке Service? | [DJANGO_SERVICES.md](../../06_application_architecture/django_services_full.md) |
| Що таке Selector? | [DJANGO_SELECTORS.md](../../06_application_architecture/django_selectors_full.md) |
| Як не дублювати ORM-запити? | [DJANGO_SELECTORS.md](../../06_application_architecture/django_selectors_full.md) |
| Як правильно відправити Celery task? | [DJANGO_TASKS.md](../../06_application_architecture/django_tasks_full.md) |
| Що таке Celery broker і worker? | [DJANGO_TASKS.md](../../06_application_architecture/django_tasks_full.md) |
| Як зробити task ідемпотентним? | [DJANGO_TASKS.md](../../06_application_architecture/django_tasks_full.md) |
| Що таке InputSerializer / OutputSerializer? | [DJANGO_SERIALIZERS.md](../../06_application_architecture/django_serializers_full.md) |
| Як валідувати вхідні дані? | [DJANGO_SERIALIZERS.md](../../06_application_architecture/django_serializers_full.md) |
...
|--------|-------|--------|--------------|
| [Hello, Django!](../legacy_source/legacy_missing_reference.md) | `simple_django_project/` | Початківець | Покрокова інструкція: venv → перша сторінка у браузері. Тільки README + requirements.txt |
| [Новинний портал](../legacy_source/legacy_missing_reference.md) | `news_portal/` | Базовий | Повноцінний сайт: моделі, вьюшки, шаблони, адмін-панель, парсер rbc.ua, Docker + PostgreSQL |
