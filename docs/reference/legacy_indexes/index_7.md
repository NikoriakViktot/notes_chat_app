> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/INDEX_7.md`.
...
|---|------|------|---------------------|
| 1 | [01_sync_vs_async.md](../../09_async_and_realtime/async_01_sync_vs_async_full.md) | Синхронне vs асинхронне виконання | Навіщо існує async і що таке blocking |
| 2 | [02_asyncio.md](../../09_async_and_realtime/async_02_asyncio_full.md) | Python asyncio | Як coroutine, await і event loop працюють разом |
| 3 | [03_asgi.md](../../09_async_and_realtime/async_03_asgi_full.md) | WSGI та ASGI | Чому Django потребує ASGI для справжнього async |
| 4 | [04_django_async_views.md](../../09_async_and_realtime/async_04_django_async_views_full.md) | Django Async Views | Як писати async def view і коли це корисно |
| 5 | [05_async_orm.md](../../09_async_and_realtime/async_05_async_orm_full.md) | Async ORM | Чому async view не робить ORM автоматично асинхронним |
| 6 | [06_sync_to_async.md](../../09_async_and_realtime/async_06_sync_to_async_full.md) | sync_to_async | Як безпечно з'єднати sync і async код у Django |
| 7 | [07_async_http_clients.md](../../09_async_and_realtime/async_07_async_http_clients_full.md) | Async HTTP Clients | Чому `requests` блокує і як використовувати `httpx` |
| 8 | [08_benchmarking.md](../../09_async_and_realtime/async_08_benchmarking_full.md) | Benchmarking | Як правильно вимірювати performance sync vs async |
| 9 | [09_async_use_cases.md](../../09_async_and_realtime/async_09_async_use_cases_full.md) | Real-world Use Cases | Коли async справді потрібен, а коли ні |
