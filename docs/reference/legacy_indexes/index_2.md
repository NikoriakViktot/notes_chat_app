> Повний матеріал відновлено з `archive/legacy_docs/docs_flat/INDEX_2.md`.
...
|------|------------------|-------------------|
| [lesson_Django_Network_Architecture](../legacy_source/legacy_missing_reference.md) | MVT, URL routing, HttpResponse, прості view | simple_django_project, news_portal |
| [lesson_Django_ORM_Database](../legacy_source/legacy_missing_reference.md) | ORM, Services/Selectors, FBV, Bootstrap5-форми вручну | notes_chat_app, notes_chat_app |
| **lesson_HTML_CSS_Bootstrap** (цей урок) | HTML/CSS/Bootstrap, Advanced Templates, Crispy Forms, Design Foundations | django_bootstrap_project, crispy_notes_chat_app |
...
|------|--------|--------|------|
| [DESIGN_FOUNDATIONS.md](../../05_frontend_and_templates/design_foundations_full.md) | ~650 | 0 | UX, CRAP, IA, Bootstrap-філософія, Django Template Architecture, Crispy Forms, Tailwind vs Bootstrap, Static Files, React+Django |
| [CRISPY_FORMS.md](../../04_forms_and_validation/crispy_forms_full.md) | ~300 | 3 | django-crispy-forms довідник: FormHelper, всі Layout-компоненти, template tags, приклади |
| [HTML_BASICS.md](../../05_frontend_and_templates/html_basics_full.md) | 1038 | 1 | DOM pipeline, теги, форми, семантика, a11y, DevTools |
| [CSS_BASICS.md](../../05_frontend_and_templates/css_basics_full.md) | 1124 | 2 | Rendering Pipeline, Box Model, Flexbox, Grid, Holy Grail, Debugging |
| [BOOTSTRAP_5.md](../../05_frontend_and_templates/bootstrap_5_full.md) | 1388 | 3 | Grid, Breakpoints, Navbar, Card, Modal, Forms, JS API, Accessibility |
| [DJANGO_TEMPLATES_BOOTSTRAP.md](../../05_frontend_and_templates/django_templates_bootstrap_full.md) | 1015 | 4 | SSR lifecycle, DTL, Template Inheritance, Static Files, Bootstrap Forms |
| [DJANGO_NINJA_TEMPLATES.md](../../06_application_architecture/django_ninja_templates_full.md) | 960 | 5 | Django Ninja, TemplateResponse, Jinja2 intro, HTMX intro, Swagger |
| [ADVANCED_TEMPLATES.md](../../05_frontend_and_templates/advanced_templates_full.md) | 1506 | 6 | Context Processors, Custom Tags, crispy-forms, Vite, SaaS Dashboard, Jinja2 Deep Dive, HTMX lifecycle |
| [DJANGO_ADMIN_UNFOLD.md](../../05_frontend_and_templates/django_admin_unfold_full.md) | 2171 | 7 | Django Admin + Unfold: AdminSite, ModelAdmin, Dashboard, Widgets, Filters, Caching |

**Практичні проєкти:**
- [django_bootstrap_project/README.md](../legacy_source/legacy_missing_reference.md) — CRUD-нотатки: Navbar, Card Grid, Forms, Messages, Debug Toolbar
- [crispy_notes_chat_app/README.md](../../../README.md) — Notes CRUD з `django-crispy-forms` FormHelper+Layout, SaaS Dashboard (`layouts/` + `components/`), порівняння 3 рівнів рендерингу форм
